if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
  ...
  wait(10)
      ...
      do
          local ui = game.CoreGui:FindFirstChild("Attack V2GUI")
          if ui then
              ui:Destroy()
          end
      end
  ...
  elseif placeId == 7449423635 then
      ...
      local sxhub = library:AddWindow("Attack V2 HUB | Bloxfruit!",Enum.KeyCode.RightControl)
  ...
  set:AddLabel("Setting")
      ...
      set:AddButton("Copy link Attack V2 Discord ",function()
      setclipboard("")
  end)
      ...
      pcall(function()
          while wait() do
              if _G.Redeem and game.Players.LocalPlayer.Data.Level.Value >= 850 then
                  ...
                  UseCode"THEGREATACE"
                  UseCode"SUB2GAMERROBOT_EXP1"
                  UseCode"STRAWHATMAIME"
                  UseCode"SUB2OFFICIALNOOBIE"
                  UseCode"SUB2NOOBMASTER123"
                  UseCode"SUB2DAIGROCK"
                  UseCode"AXIORE"
                  UseCode"TANTAIGAMIMG"
                  UseCode"STRAWHATMAINE"
                  UseCode"JCWK"
                  UseCode"FUDD10_V2"
                  UseCode"SUB2FER999"
  ...
  wait(10)
      ...
      --
      local RenUi = library:AddWindow("PROXO HUB | King Legacy",Enum.KeyCode.RightControl)
      --
...
coroutine.wrap(function()
    game:GetService("RunService").Stepped:Connect(function()
        if getupvalues(CombatFramework)[2]['activeController'].timeToNextAttack then
            ...
            getupvalues(CombatFramework)[2]['activeController'].hitboxMagnitude = 180
